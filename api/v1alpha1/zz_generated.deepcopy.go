...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActionsEnvoyFilter) DeepCopyInto(out *ActionsEnvoyFilter) {
	*out = *in
	if in.Actions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionsEnvoyFilter.
func (in *ActionsEnvoyFilter) DeepCopy() *ActionsEnvoyFilter {
	if in == nil {
		return nil
	}
	out := new(ActionsEnvoyFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OutputRatelimitsEnvoyFilter) DeepCopyInto(out *OutputRatelimitsEnvoyFilter) {
	*out = *in
	if in.RateLimits != nil {
		...
		*out = make([]ActionsEnvoyFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
