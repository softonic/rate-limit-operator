...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitsEF) DeepCopyInto(out *RateLimitsEF) {
	*out = *in
	if in.Actions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitsEF.
func (in *RateLimitsEF) DeepCopy() *RateLimitsEF {
	if in == nil {
		return nil
	}
	out := new(RateLimitsEF)
	in.DeepCopyInto(out)
	return out
}
